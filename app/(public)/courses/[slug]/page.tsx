      ...
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-12 space-y-6">
          <div className="flex items-center justify-between ">
            ...
            <div>
              {course.courseChapters.length} chapters |{" "}
              {course.courseChapters.reduce(
                      ...
                      <CardContent className="p-6 hover:bg-muted/50 transition-colors">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <p className="flex size-10 items-center justify-center rounded-full bg-primary/10 ">
                              {index + 1}
                            </p>
                            <div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <IconChevronCompactDown className="size-5 text-muted-foreground" />
                          </div>
                        </div>
                      </CardContent>
                    </div>
